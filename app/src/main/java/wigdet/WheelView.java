...
import wigdet.adapters.WheelViewAdapter;
...
//			0x00AAAAAA, 0x00AAAAAA };
    ...
    // View com.example.administrator.atandroid.adapter
    ...
    /**
     * Gets view com.example.administrator.atandroid.adapter
     *
     * @return the view com.example.administrator.atandroid.adapter
     */
    ...
    /**
     * Sets view com.example.administrator.atandroid.adapter. Usually new adapters contain different views, so
     * it needs to rebuild view by calling measure().
     *
     * @param viewAdapter the view com.example.administrator.atandroid.adapter
     */
...
//		int height = (int)(1.5 * getItemHeight());
		//*/
        int height = (int) (2.5 * getItemHeight());
        //*/
